...
const translations = {
    en: {
        ...
        'home.skills': 'Skills',
        'home.skills.hard': 'Hard Skills',
        'home.skills.soft': 'Soft Skills',
        'home.skills.networking': 'Networking',
        'home.skills.hardware': 'Computer Hardware',
        'home.skills.teamwork': 'Teamwork',
        'home.skills.communication': 'Communication',
        'home.skills.adaptability': 'Adaptability',
        'home.skills.dependability': 'Dependability',
        'home.skills.openminded': 'Open-minded',
        ...
        'grading.tech': 'Technologies Used',
        'grading.tech.backend': 'Backend:',
        'grading.tech.backend.value': 'Python',
        'grading.tech.deploy': 'Deployment:',
        'grading.tech.deploy.value': 'Docker & Docker Compose',
        'grading.tech.arch': 'Architecture:',
        'grading.tech.arch.value': 'Multi-container web application',
        'grading.tech.roles': 'User Roles:',
        'grading.tech.roles.value': 'Administrator, Teacher, Student',
        ...
        // LME project page
        'lme.subtitle': 'Group Project - Secure Multi-Tenant Hosting Platform',
    ...
    fr: {
        ...
        'home.skills.hard': 'Compétences techniques',
        'home.skills.soft': 'Compétences personnelles',
        'home.skills.networking': 'Réseaux',
        'home.skills.hardware': 'Matériel informatique',
        'home.skills.teamwork': 'Travail d\'équipe',
        'home.skills.communication': 'Communication',
        'home.skills.adaptability': 'Adaptabilité',
        'home.skills.dependability': 'Fiabilité',
        'home.skills.openminded': 'Ouverture d\'esprit',
        ...
        'grading.tech': 'Technologies utilisées',
        'grading.tech.backend': 'Backend :',
        'grading.tech.backend.value': 'Python',
        'grading.tech.deploy': 'Déploiement :',
        'grading.tech.deploy.value': 'Docker & Docker Compose',
        'grading.tech.arch': 'Architecture :',
        'grading.tech.arch.value': 'Application web multi-conteneurs',
        'grading.tech.roles': 'Rôles utilisateurs :',
        'grading.tech.roles.value': 'Administrateur, Enseignant, Élève',
        ...
        // LME project page
        'lme.subtitle': 'Projet de groupe - Plateforme d\'hébergement multi-tenant sécurisée',
