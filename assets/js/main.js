...
const translations = {
    en: {
        ...
        'bts.learned.azure.desc': 'I built a solid foundation in Microsoft Azure, from the AZ-900 (Azure Fundamentals) certification through the AZ-104 (Azure Administrator) path. I learned how to manage identities and access through a central directory and organise resources with a clear governance hierarchy, as well as how to deploy and manage cloud compute resources such as virtual machines, scale sets, containers, and app services. I also worked with high availability and load balancing to keep services running across multiple instances, and used low-code tools to build applications quickly. In practice I configured networking and security, connected to machines using several methods, and set up reverse proxies and cost controls.',
        ...
        'bts.learned.security.title': 'Security',
        'bts.learned.security.desc': 'I developed a security-focused mindset, learning to protect systems by isolating sensitive services, controlling access, and thinking about how a setup could be attacked and how to reduce that risk.',
        'bts.learned.linux.title': 'Linux & System Administration',
        'bts.learned.linux.desc': 'I became comfortable administering Linux systems from the command line — configuring services, managing users and permissions, and maintaining servers — which gave me a foundation for most modern server and cloud work.',
        ...
        'bts.progress.s2.multiproject.title': 'Working on Multiple Projects Simultaneously',
        'bts.progress.s2.multiproject.desc': 'Semester 2 often meant several projects running in parallel at the same time. I learned how to manage competing deadlines, switch between different tasks without losing track, and prioritise my work so that every project progressed steadily instead of leaving things until the last minute.',
        ...
        'exp.jager.title': 'External Professional - Jamey Jager',
        'exp.jager.date': '2026',
        'exp.jager.desc': 'Jamey Jager, an external professional, visited our class to deliver two courses on project management, covering how to plan, structure, and manage a project from start to finish using established methods and best practices.',
    ...
    fr: {
        ...
        'bts.learned.azure.title': 'Microsoft Azure',
        'bts.learned.azure.desc': 'J\'ai acquis une base solide dans Microsoft Azure, de la certification AZ-900 (Azure Fundamentals) au parcours AZ-104 (Azure Administrator). J\'ai appris à gérer les identités et les accès via un annuaire central et à organiser les ressources selon une hiérarchie de gouvernance claire, ainsi qu\'à déployer et gérer des ressources de calcul cloud comme des machines virtuelles, des scale sets, des conteneurs et des app services. J\'ai également travaillé avec la haute disponibilité et la répartition de charge pour maintenir les services en fonctionnement sur plusieurs instances, et utilisé des outils low-code pour créer rapidement des applications. En pratique, j\'ai configuré le réseau et la sécurité, connecté des machines via plusieurs méthodes, et mis en place des reverse proxies et des contrôles de coûts.',
        'bts.learned.virt.title': 'Virtualisation',
        ...
        'bts.learned.security.title': 'Sécurité',
        'bts.learned.security.desc': 'J\'ai développé un état d\'esprit axé sur la sécurité, apprenant à protéger les systèmes en isolant les services sensibles, en contrôlant les accès, et en réfléchissant à la manière dont une installation pourrait être attaquée et comment réduire ce risque.',
        'bts.learned.linux.title': 'Linux et administration système',
        'bts.learned.linux.desc': 'Je suis devenu à l\'aise dans l\'administration de systèmes Linux en ligne de commande — configurer des services, gérer les utilisateurs et les permissions, et maintenir des serveurs — ce qui m\'a donné une base pour la plupart des travaux serveur et cloud modernes.',
        ...
        'bts.progress.s2.multiproject.title': 'Travailler sur plusieurs projets simultanément',
        'bts.progress.s2.multiproject.desc': 'Le semestre 2 impliquait souvent plusieurs projets menés en parallèle en même temps. J\'ai appris à gérer des échéances concurrentes, à passer d\'une tâche à l\'autre sans perdre le fil, et à prioriser mon travail pour que chaque projet progresse régulièrement plutôt que de tout laisser à la dernière minute.',
        ...
        'exp.jager.title': 'Professionnel externe - Jamey Jager',
        'exp.jager.date': '2026',
        'exp.jager.desc': 'Jamey Jager, professionnel externe, est intervenu dans notre classe pour dispenser deux cours sur la gestion de projet, couvrant la manière de planifier, structurer et gérer un projet du début à la fin à l\'aide de méthodes établies et de bonnes pratiques.',
